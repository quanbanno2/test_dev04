...
from project_manage.forms import project_form
...
def manage(request):
    ...
    return render(request, 'project/project_manage.html', {"accountName": accountName, "projects": projects})
    ...
    if request.method == "POST":
        ...
        if pid:
            try:
                ...
                form = project_form(instance=p)  # 生产带数据表单
